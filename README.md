...
- [Lightning Rod (Foresight)](https://www.lightningrod.ai/models) — AI forecasting models that return calibrated probabilities instead of plausible text, exposed through an OpenAI-compatible API with built-in research and structured probabilistic answers for building prediction-market bots, market makers, forecasting agents and more.
